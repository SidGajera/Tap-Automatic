...
public final class SmallAdUnifiedBinding implements ViewBinding {
  @NonNull
  ...
  private SmallAdUnifiedBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static SmallAdUnifiedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SmallAdUnifiedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.small_ad_unified, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SmallAdUnifiedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SmallAdUnifiedBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
