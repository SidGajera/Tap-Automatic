...
public final class BigAdUnifiedBinding implements ViewBinding {
  @NonNull
  ...
  private BigAdUnifiedBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static BigAdUnifiedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BigAdUnifiedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.big_ad_unified, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BigAdUnifiedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BigAdUnifiedBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
