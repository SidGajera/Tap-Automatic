...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
  ...
  private ActivityPrivacyPolicyBinding(@NonNull RelativeLayout rootView, @NonNull ImageView back,
      @NonNull RelativeLayout header, @NonNull WebView webview) {
  ...
  public static ActivityPrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyPolicyBinding((RelativeLayout) rootView, back, header, webview);
    }
