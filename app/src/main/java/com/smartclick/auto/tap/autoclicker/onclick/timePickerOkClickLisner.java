...
public final class timePickerOkClickLisner implements Runnable {
    public final SingleModeService f$0;

    public timePickerOkClickLisner(SingleModeService singleModeService) {
        this.f$0 = singleModeService;
    }

    public final void run() {
        this.f$0.timePickerRun();
    }
}
