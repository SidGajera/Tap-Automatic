...
public final class mSettingRlClickListener implements View.OnClickListener {
    public final StartActivity f$0;

    public mSettingRlClickListener(StartActivity startActivity) {
        this.f$0 = startActivity;
    }

    public final void onClick(View view) {
        this.f$0.mSettingRlOnClick(view);
    }
}
