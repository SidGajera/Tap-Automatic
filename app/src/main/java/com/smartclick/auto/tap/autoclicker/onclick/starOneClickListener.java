...
public final class starOneClickListener implements View.OnClickListener {
    public final StartActivity f$0;
    public final RateDialogBinding f$1;

    public starOneClickListener(StartActivity startActivity, RateDialogBinding rateDialogBinding) {
        this.f$0 = startActivity;
        this.f$1 = rateDialogBinding;
    }

    public final void onClick(View view) {
        this.f$0.starOneOnClick(this.f$1, view);
    }
}
