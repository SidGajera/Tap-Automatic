...
public final class starFiveClickListener implements View.OnClickListener {
    public final StartActivity f$0;
    public final RateDialogBinding f$1;

    public starFiveClickListener(StartActivity startActivity, RateDialogBinding rateDialogBinding) {
        this.f$0 = startActivity;
        this.f$1 = rateDialogBinding;
    }

    public final void onClick(View view) {
        this.f$0.starFiveOnClick(this.f$1, view);
    }
}
