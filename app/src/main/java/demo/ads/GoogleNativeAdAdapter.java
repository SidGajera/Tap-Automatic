...
public class GoogleNativeAdAdapter extends RecyclerViewAdapterWrapper {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter, demo.ads.RecyclerViewAdapterWrapper
    ...
    private void setSpanAds() {
        if (this.mParam.gridLayoutManager != null) {
            ...
            this.mParam.gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                /* class demo.ads.GoogleNativeAdAdapter.AnonymousClass1 */
    ...
    public static class Builder {
        ...
        public static Builder with(Context context, String str, RecyclerView.Adapter adapter) {
            ...
            MobileAds.initialize(GoogleNativeAdAdapter.mContext, new OnInitializationCompleteListener() {
                /* class demo.ads.GoogleNativeAdAdapter.Builder.AnonymousClass1 */
    ...
    private void refreshAd(String str, int i, final LinearLayout linearLayout) {
        ...
        builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
            /* class demo.ads.GoogleNativeAdAdapter.AnonymousClass2 */
            ...
            public void onNativeAdLoaded(NativeAd nativeAd) {
                ...
                NativeAdView nativeAdView = (NativeAdView) ((LayoutInflater) GoogleNativeAdAdapter.mContext.getSystemService("layout_inflater")).inflate(R.layout.ad_unified, (ViewGroup) null);
        ...
        builder.withAdListener(new AdListener() {
            /* class demo.ads.GoogleNativeAdAdapter.AnonymousClass3 */
